...
private:
    ...
    const size_t mismatch_limit_ = 100;
};
/*
...
void warrior_report(int time_index) {
    for (int pos=0;pos<=N+1;pos++) {
        if (war_map[pos].red_warrior) {
            ...
            if (out_inf.empty()) {
                cout<<"no weapon"<<".elements"<<w->life_value<<" froce "<<w->attack_value<<endl;
                continue;
            }
            ...
            cout<<".elements"<<w->life_value<<" froce "<<w->attack_value<<endl;
        }
    }
    for (int pos=0;pos<=N+1;pos++) {
        if (war_map[pos].blue_warrior) {
            ...
            cout<<w->life_value<<" froce "<<w->attack_value<<endl;
        }
    }
}
